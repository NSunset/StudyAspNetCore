...
namespace Order.MicroServie.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Order.MicroServie.Api", Version = "v1" });
            });

            services.AddSingleton<IAccountService, AccountServiceImpl>();
            services.AddSingleton<IStorageService, StorageServiceImpl>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Order.MicroServie.Api v1"));
            }
